 ...
 *         | if (this.globalTarget.getxpos()<this.getCubeXpos()+0.5)
 * 		   | then dx = -1
 *         | else if (this.globalTarget.getxpos()>this.getCubeXpos()+0.5)
 *         | then dx = 1
 *         | else dx = 0
 *         | if (this.globalTarget.getypos()<this.getCubeYpos()+0.5)
 * 	       | then dy = -1
 *         | else if (this.globalTarget.getypos()>this.getCubeYpos()+0.5)
 *         | then dy = 1
 *         | else dy = 0
 *         | if (this.globalTarget.getzpos()<this.getCubeZpos()+0.5)
 * 		   | then dz = -1
 *         | else if (this.globalTarget.getzpos()>this.getCubeZpos()+0.5)
 *         | then dz = 1
 *         | else dz = 0
 *         | setLocalTargetAndSpeed(dx,dy,dz)
 * @throws UnitException
